...
#ifndef ADDER1W2TO1W1_H
#define ADDER1W2TO1W1_H
...
/*!
 * \brief Třída reprezentující bloky Adder1w2to1w1
 */
class Adder1w2to1w1 : public AbstractBlock {
private:
    /*!
     ...
     */
    const QString IN_PORTS_LABELS[IN_PORTS_COUNT] = {"1.2"};

    /*!
     * \brief IN_PORTS_DATA_TYPES[] - konstanta pro nastavení typů dat vstupních potrů bloku
     */
    const QString IN_PORTS_DATA_TYPES[IN_PORTS_COUNT] = {"Two Decimal Numbers"};
     ...
     */
    const QString BLOCK_CLASS_NAME = "Adder1w2to1w1";

public:
    /*!
     * \brief Konstruktor pro blok Adder1w2to1w1
     * \param x - x-ová souřadnice umístění bloku
     * \param y - y-nová souřadnice umístění bloku
     * \param parent - ukazatel na rodiče (scénu)
     */
    Adder1w2to1w1(int x, int y, QGraphicsScene *parent = 0);
