...
/*!
 * \brief Třída reprezentující bloky Adder1w1a2w2a3w3to1w1a2w1
 */
...
private:
     ...
     */
    const QString BLOCK_CLASS_NAME = "Adder1w1a2w2a3w3to1w1a2w1";

public:
    /*!
     * \brief Konstruktor pro blok Adder1w1a2w2a3w3to1w1a2w1
