...
/*!
 * \brief Třída reprezentující bloky Multiplier
 */
...
private:
    ...
    /*!
     * \brief OUT_PORTS_COUNT[] - konstanta pro nastavení typů dat výstupních potrů bloku
     */
     ...
     */
    const QString BLOCK_CLASS_NAME = "Multiplier";

public:
    /*!
     * \brief Konstruktor pro blok Multiplier
