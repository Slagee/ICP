...
/*!
 * \brief Třída reprezentující typ Water
 */
class Water : public AbstractType {

private:
    /*!
     * \brief TYPE_NAME - konstanta pro nastavení názvu typu"
     */
    const QString TYPE_NAME = "Water";
     ...
     */
    const QString VALUES_NAMES[NUMBER_OF_VALUES] = {"Water"};
