...
/*!
 * \brief Třída reprezentující typ Methan
 */
class Methan : public AbstractType {
private:
    /*!
     * \brief TYPE_NAME - konstanta pro nastavení názvu typu"
     */
    const QString TYPE_NAME = "Methan";
     ...
     */
    const QString VALUES_NAMES[NUMBER_OF_VALUES] = {"Methan"};
